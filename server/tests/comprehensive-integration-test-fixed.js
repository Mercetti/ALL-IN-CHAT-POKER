/**
 * Comprehensive Integration Test Suite - Fixed Paths
...
runTest('helmEngine', 'Helm engine exports correct classes', () => {
  const helmIndexPath = path.resolve(__dirname, 'helm/index.ts');
...
runTest('personaSystem', 'Persona loader exists and exports correctly', () => {
  const loaderPath = path.resolve(__dirname, 'personas/helmPersonaLoader.ts');
