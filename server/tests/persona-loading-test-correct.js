/**
 * Persona Loading System Test - Correct Paths
...
const personaLoaderPath = path.resolve(__dirname, 'personas/helmPersonaLoader.ts');
...
const personaConfigPath = path.resolve(__dirname, '../personas/acey/persona-config.ts');
...
const systemPromptPath = path.resolve(__dirname, '../personas/acey/prompts/system-prompt.md');
