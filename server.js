...
const securityHeadersMiddleware = (req, res, next) => {
  ...
  const csp = [
    ...
    "connect-src 'self' https://id.twitch.tv https://gql.twitch.tv https://www.twitch.tv https://ertwjobuopcnrmdojeps.supabase.co https://cdn.jsdelivr.net https://cdn.socket.io",
