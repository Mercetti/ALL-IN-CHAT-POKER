...
const startupHealth = { getHealth: fetchStartupHealth };
...
// Startup/health subsystems integration
const { checkStartup: doStartupChecks, logStartupCheck: doLogStartupCheck, getHealth: fetchStartupHealth } = require('./server/startup');
