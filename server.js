...
const startupHealth = { getHealth: startupHealthFn };
...
// Startup/health subsystems integration
const { checkStartup: doStartupChecks, logStartupCheck: doLogStartupCheck, getHealth: startupHealthFn } = require('./server/startup');
