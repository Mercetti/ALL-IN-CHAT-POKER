      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.statusGrid}>
            ...
            <View style={styles.statusCard}>
              <Text style={styles.statusLabel}>Throttling</Text>
              <Text style={styles.statusValue}>
                {state.throttlingLevel || 'OFF'}
              </Text>
            </View>
            
            <View style={styles.statusCard}>
              <Text style={styles.statusLabel}>Resource Limits</Text>
              <Text style={styles.statusValue}>
                CPU: {state.cpuLimit}% | Memory: {state.memoryLimit}% | Tokens: {state.tokenLimit}% | Connections: {state.connectionLimit}/100}
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.controlGrid}>
            <TouchableOpacity
              ...
              onPress={() => actions.setThrottlingLevel('low')}
            >
              <Text style={styles.controlButtonText}>Set Throttling</Text>
            </TouchableOpacity>
            
            <TouchableOpacity
              style={styles.controlButton}
              onPress={() => actions.setMode('live')}
            >
              <Text style={styles.controlButtonText}>Set Live Mode</Text>
            </TouchableOpacity>
            
            <TouchableOpacity
              style={styles.controlButton}
              onPress={() => actions.setMode('build')}
            >
              <Text style={styles.controlButtonText}>Set Build Mode</Text>
            </TouchableOpacity>
            
            <TouchableOpacity
              style={styles.controlButton}
              onPress={() => actions.setMode('safe')}
            >
              <Text style={styles.controlButtonText}>Set Safe Mode</Text>
            </TouchableOpacity>
            
            <TouchableOpacity
              style={styles.controlButton}
              onPress={() => actions.setMode('offline')}
            >
              <Text style={styles.controlButtonText}>Set Offline Mode</Text>
            </TouchableOpacity>
            ...
            >
              <Text style={styles.controlButtonText}>Enable Auto-Optimization</Text>
            </TouchableOpacity>
          ...
          <View style={styles.resourceGrid}>
            <View style={styles.resourceCard}>
              ...
              <View style={styles.resourceBar}>
                <View style={[styles.resourceFill, { width: `${getCPUPercent(state.cpuUsage || 0, state.cpuLimit || 100)}%` }]} />
                <Text style={styles.resourceText}>
                  {getCPUPercent(state.cpuUsage || 0, state.cpuLimit || 100)}%
                </Text>
              </View>
            ...
            <View style={styles.resourceCard}>
              ...
              <View style={styles.resourceBar}>
                <View style={[styles.resourceFill, { width: `${getMemoryPercent(state.memoryUsage || 0, state.memoryLimit || 100)}%` }]} />
                <Text style={styles.resourceText}>
                  {getMemoryPercent(state.memoryUsage || 0, state.memoryLimit || 100)}%
                </Text>
              </View>
              <Text style={styles.resourceLimit}>
                / {state.memoryLimit || 100}%
              </Text>
            </View>
            ...
            <View style={styles.resourceCard}>
              ...
              <View style={styles.resourceBar}>
                <View style={[styles.resourceFill, { width: `${getMemoryPercent(state.tokenUsage || 0, state.tokenLimit || 100)}%` }]} />
                <Text style={styles.resourceText}>
                  {getMemoryPercent(state.tokenUsage || 0, state.tokenLimit || 100)}%
                </Text>
              </View>
              <Text style={styles.resourceLimit}>
                / {state.tokenLimit || 100}%
              </Text>
            </View>
            ...
            <View style={styles.resourceCard}>
              ...
              <Text style={styles.statusValue}>
                {state.connections || '0'} / {state.connectionLimit || '100'}
              </Text>
            </View>
          </View>
        </View>
