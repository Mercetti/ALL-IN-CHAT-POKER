...
Object.keys(multiCurrencyReport.convertedAmounts).forEach(partnerId => {
  ...
  console.log(`📊 ${partner.name}:`);
  console.log(`   USD: $${multiCurrencyReport.convertedAmounts[partner.partnerId].USD || 'N/A'}`);
  console.log(`   EUR: €${multiCurrencyReport.convertedAmounts[partner.partnerId].EUR || 'N/A'}`);
  console.log(`   GBP: £${multiCurrencyReport.convertedAmounts[partner.partnerId].GBP || 'N/A'}`);
  console.log(`   CAD: C$${multiCurrencyReport.convertedAmounts[partner.partnerId].CAD || 'N/A'}`);
});
...
const financialIntegrationReport = `# Acey Financial Integration Test Report
